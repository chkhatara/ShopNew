        ...
        <div class="row">
            ...
            <div class="col-md-9">
                <div class="slider">
                    ...
                    int sizePh = db.getCompanyPhotoNum(shop.getEmail());
                    for (int i=0;i<sizePh;i++){ %>
                        <li>
                            <a href="#">
                                <img src="GetCompanyPicture?id=<%= db.getShopId(shop.getEmail()) %>&photoId=<%= i+1 %>" alt=""/>
                            </a>
                        </li>
                        <%} %>
                    </ul>
                ...
                <div class="thumbnail">
                    ...
                    <img class="img-responsive" src="GetCompanyPicture?id=<%= db.getShopId(shop.getEmail()) %>" alt="">
                ...
                ArrayList<Item> allItems = db.getShopItems(db.getShopId(shop.getEmail()));
 ...
 <nav>
	  ...
	  <%}else{
		  if(request.getParameter("page")==null||Integer.parseInt(request.getParameter("page"))==0){
			  %>
			  <li class="pager-prev disabled"><a href="#">Older</a></li>
			  <li class="pager-next "><a href="ShopPageForPerson?page=1&shopid=<%=(String)request.getParameter("shopid")%>">Newer</a></li>
		  ...
		  <%
			  ...
			  %>
			  <li class="pager-prev"><a href="ShopPageForPerson?page=<%= pageNum-1%>&shopid=<%=(String)request.getParameter("shopid")%>">Older</a></li>
			  <li class="pager-next "><a href="ShopPageForPerson?page=<%= pageNum+1%>&shopid=<%=(String)request.getParameter("shopid")%>">Newer</a></li>
		 <%  }else{
